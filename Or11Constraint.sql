...
/*
default : insert 시 아무런 값도 입력하지 않았을때 자동으로 삽입되는 데이터를 지정할 수 있다.
*/
...
insert into tb_default values('ccc',default);--default값 입력
insert into tb_default values('ddd','');--null입력
insert into tb_default values('eee',' ');--공백 입력

/*
    default값을 입력하려면 insert문에서 컬럼을 제외시키거나
    default 키워드를 사용해야한다.
*/

/*
check : Domain 무결성을 유지하기 위한 제약조건을 해당 컬럼에 잘못된 데이터가 입력되지 않도록 유지한다.
*/

...
insert into tb_member 
    values(1, 'kosmo1', '1234', '코스모155기','kosmo155@naver.com');
insert into tb_member 
    values(2, 'kosmo2', '1234', '코스모156기','kosmo156@gmail.com');
insert into tb_member 
    values(3, 'kosmo3', '1234', '코스모157기','kosmo157@nate.com');

--삽입된 레코드 확인하기
select * from tb_member;
--명시적으로 true인 조건이므로 모든 레코드를 대상으로 인출
select * from tb_member where 1=1;
--명시적으로 false인 조건이므로 레코드를 인출하지 않는다.
